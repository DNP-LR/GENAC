...
/* Date de création :  25/09/2022 17:40:04                      */
/*==============================================================*/
...
(
   ...
   dateDeclarationDeces varchar(254)                   null,
   nomDeclarant         varchar(254)                   null,
   professionDeclarant  varchar(254)                   null,
   qualiteDeclarant     varchar(254)                   null,
...
(
   ...
   nomTemoin1           varchar(254)                   null,
   professionTemoin1    varchar(254)                   null,
   dateDeNaissTemoin1   timestamp                      null,
   lieuNaissTemoin1     varchar(254)                   null,
   Temoin1              varchar(254)                   null,
   nomTemoin2           varchar(254)                   null,
   professionTemoin2    varchar(254)                   null,
   dateDeNaissTemoin2   timestamp                      null,
   lieuNaissTemoin2     varchar(254)                   null,
